...
CREATE TABLE `articles` (
  `NO_ARTICLE` int(6) NOT NULL AUTO_INCREMENT ,
...
CREATE TABLE `commandes` (
  `NO_COMMAND` int(6) NOT NULL AUTO_INCREMENT,
  `NO_VENDEUR` int(6) NOT NULL,
  `NO_CLIENT` int(6) NOT NULL,
...
CREATE TABLE `compose` (
  `NO_COMPOSE` int(6) NOT NULL,
  `NO_COMPOSANT` int(6) NOT NULL,
...
CREATE TABLE `detail_cde` (
  `NO_COMMAND` int(6) NOT NULL,
  `NO_ARTICLE` int(6) NOT NULL,
...
CREATE TABLE `vendeur` (
  `NO_VENDEUR` int(6) NOT NULL AUTO_INCREMENT,
  `NO_VEND_CHEF_EQ` int(6) NOT NULL,
  `NOM_VEND` char(20) NOT NULL,
  `PRENOM_VEND` char(20) NOT NULL,
